...
+ Hidden Markov Model :: [[https://web.stanford.edu/~jurafsky/slp3/A.pdf][PDF (Concise)]], More
  ...
  Tutorial]].
+ Time Delay DNN (TDNN) :: [[https://paperswithcode.com/paper/jasper-an-end-to-end-convolutional-neural#code][Jasper]], [[https://paperswithcode.com/paper/quartznet-deep-automatic-speech-recognition][QuartzNet]], [[https://paperswithcode.com/paper/citrinet-closing-the-gap-between-non][Citrinet]]
...
[[https://colab.research.google.com/github/NVIDIA/NeMo/blob/stable/tutorials/asr/ASR_with_NeMo.ipynbASR_with_NeMo][ASR with NeMo (Colab)]]
