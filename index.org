...
+ Spectrogram Generators :: Tacotron2: Further Reading
  [[https://paperswithcode.com/paper/natural-tts-synthesis-by-conditioning-wavenet][[Papers with code]​]], GlowTTS: Further Reading [[https://paperswithcode.com/paper/glow-tts-a-generative-flow-for-text-to-speech][[Papers
  with code]​]]
+ Audio Generators :: Wavenet: [[https://docs.google.com/presentation/d/11UHK4QGZfjIdoPXUN4hDEw6Z2U8p1Q4ujmrbiyFOIhQ/edit?usp=sharing][[Google Slides]​]];
  WaveGlow: Further Reading [[https://paperswithcode.com/paper/waveglow-a-flow-based-generative-network-for][[Papers with code]​]];
  SqueezeWave: Further Reading [[https://cs.paperswithcode.com/paper/squeezewave-extremely-lightweight-vocoders][[Papers with code]​]].
