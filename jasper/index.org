...
/Adapted from [[http://arxiv.org/abs/1607.06450][Layer Normalisation Paper]],/
#+begin_quote
...
\begin{align}
  \notag
  \mathrm{erf}\;z &= \frac2{\sqrt2} \int_0^z e^{-t^2}
                   \mathrm{d}t 
\end{align}
...
#+end_quote
Also see [[https://arxiv.org/abs/1404.7828][Deep Learning by Jürgen Schmidhuber]]
